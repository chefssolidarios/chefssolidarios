        ...
        <div className="relative sm:mx-auto">
          <div className="flex flex-col lg:flex-row  sm:mb-0 lg:items-end lg:justify-between">
            ...
            <div>
              <a
                href="mailto:chefsolidarios.donar@gmail.com?subject=EMPRESAS"
                className="inline-flex lg:items-center mt-6 justify-center px-6 text-center tracking-wide text-white transition duration-200  shadow-md bg-chefs-800 hover:bg-chefs-500 focus:shadow-outline focus:outline-none text-base font-semibold rounded-2xl lg:rounded-3xl md:text-xl py-4 lg:text-3xl lg:py-7"
